        ...
        public async Task QueueTrigger_WithNonTextualByteArrayMessageUsingQueueTriggerBindingData_Throws()
        {
            try
            {
                ...
                using (host)
                {
                    ...
                    CloudQueueMessage message = Microsoft.Azure.WebJobs.Host.FunctionalTests.Utility.CreateCloudQueueMessageFromByteArray(contents);
        ...
        public async Task QueueTrigger_WithNonTextualByteArrayMessageNotUsingQueueTriggerBindingData_DoesNotThrow()
        {
            try
            {
                ...
                using (host)
                {
                    ...
                    CloudQueueMessage message = Microsoft.Azure.WebJobs.Host.FunctionalTests.Utility.CreateCloudQueueMessageFromByteArray(expectedBytes);
