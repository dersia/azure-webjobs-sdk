...
{
    internal class OutputTableConverter<TInput> : IObjectToTypeConverter<CloudStorageAccount>
        where TInput : class
    {
        private readonly IConverter<TInput, CloudStorageAccount> _innerConverter;

        public OutputTableConverter(IConverter<TInput, CloudStorageAccount> innerConverter)
        {
